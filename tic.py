...
#download font on desktop(rename font if you have to. You can change by downloading a #new font and changing the name in the command)
    mainFont = pygame.font.SysFont('Elixia.ttf', 90)
    smallFont = pygame.font.SysFont('Elixia.ttf', 25)
